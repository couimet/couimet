...
A canonical standard for the badges shown in the public `README.md` files of repositories maintained by `couimet`. The policy lives at `docs/standards/readme-badges.md` in `couimet/couimet`; that repository is the canonical home for this policy and for the other standards listed in [`docs/standards/README.md`](./README.md).
...
Change this policy **through a pull request in `couimet/couimet`**. Every change describes:
